...
<body>
	<?php
	//memanggil file header_member.php untuk menampilkannya di halaman welcome_member.php
	...
	<div class="jumbotron" style="background-image: url(../bg.jpg); background-size: cover; background-position: center; min-height: 640px;">
		<div class="container-fluid">
			...
			case 'buku':
				include "buku.php";
				break;
						case 'buku_pinjam_member':
						include "buku_pinjam_member.php";
							break;
							case 'proses_pinjam_buku':
								include "proses_pinjam_buku.php";
								break;
																			
			default:
			//memanggil file welcome.php untuk menampilkannya di halaman welcome_member.php
				include "welcome.php";
			break;
