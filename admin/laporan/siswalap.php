...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->SetX($left += 20); $this->Cell(75, $h, 'NIS', 1, 0, 'C',true);
		$this->SetX($left += 75); $this->Cell(100, $h, 'NAMA', 1, 0, 'C',true);
		$this->SetX($left += 100); $this->Cell(150, $h, 'KELAS', 1, 0, 'C',true);
		$this->SetX($left += 150); $this->Cell(100, $h, 'JENIS', 1, 0, 'C',true);;
		//$this->Ln(20);
		
		$this->SetFont('Arial','',9);
		$this->SetWidths(array(20,75,100,150,100));
