   ...
   <div class="col-md-12">
     <section class="panel">
       ...
       <div class="panel-body table-responsive">
           ...
           <?php while ($row = mysqli_fetch_array($tampil)) { ?>
             <tbody>
               <tr>
                 ...
                 <td align="center"><a href="?page=pengembalian-member&idtrx=<?php echo $row['0']; ?>">Kembalikan</a></td>
                 <td align="center"><a href="?page=perpanjangan-member&idtrx=<?php echo $row['0']; ?>">Perpanjang</a></td>
         ...
         <hr />
         <?php $tampil1 = mysqli_query($conn, "select peminjaman.idtrx, peminjaman.id, peminjaman.judul, peminjaman.npm, siswa.nama, peminjaman.tgl_pinjam, peminjaman.tgl_kembali, peminjaman.jmlpinjam from peminjaman,siswa where siswa.nis=peminjaman.nis and status='Dipinjam'");
